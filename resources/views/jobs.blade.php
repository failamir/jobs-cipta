	...
	<head>
		...
		<body>
			    ...
			    <div class="container">
			    	<div class="row align-items-center justify-content-between d-flex">
				      <div id="logo">
						...
						{{-- <a href="{{ url('/') }}"><img src="{{ asset('img/logo.png') }}" alt="" title="" />
						</a> --}}
						<h3>Jobs Cipta Wira Tirta</h3>
				      ...
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
						  ...
						  @else
						  <li><p title="Click to Dashboard">
							<a class="ticker-btn" href="{{ url('/admin') }}">Hai {{Auth::user()->name }} </a>
						</p>
						</li>				          				          
						  @endif
				        </ul>
			...
			<!-- Start post Area -->
			<section class="post-area section-gap" style="margin-top: -70px">
				<div class="container">
							...
							<div class="single-post d-flex flex-row">
								...
								<div class="details">
									<div class="title d-flex flex-row justify-content-between">
										<div class="titles">
											<a href="single.html"><h4>{{ $d->title }}</h4></a>
											<h6>Premium Labels Limited</h6>					
										</div>
										<ul class="btns">
											<li><a href="#"><span class="lnr lnr-heart"></span></a></li>
											<li><a href="{{ url('/apply/'.$d->id) }}">Apply This Job</a></li>
										</ul>
									</div>
									<p>
										{!! $d->job_description !!}
					...
					<div class="row d-flex justify-content-center">
						<div class="menu-content col-lg-9">
							<div class="title text-center">
								...
								<a class="primary-btn" href="{{ url('/register') }}">I am a Candidate</a>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Cipta Wira Tirta | All rights reserved 
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						</p>
