...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.dataPreparation.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.data-preparations.update", [$dataPreparation->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="nama">{{ trans('cruds.dataPreparation.fields.nama') }}</label>
                <input class="form-control {{ $errors->has('nama') ? 'is-invalid' : '' }}" type="text" name="nama" id="nama" value="{{ old('nama', $dataPreparation->nama) }}">
                @if($errors->has('nama'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('akses_file') ? 'is-invalid' : '' }}" type="number" name="akses_file" id="akses_file" value="{{ old('akses_file', $dataPreparation->akses_file) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('akses_video') ? 'is-invalid' : '' }}" type="number" name="akses_video" id="akses_video" value="{{ old('akses_video', $dataPreparation->akses_video) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('akses_forum') ? 'is-invalid' : '' }}" type="number" name="akses_forum" id="akses_forum" value="{{ old('akses_forum', $dataPreparation->akses_forum) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kuis_1') ? 'is-invalid' : '' }}" type="number" name="kuis_1" id="kuis_1" value="{{ old('kuis_1', $dataPreparation->kuis_1) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kuis_2') ? 'is-invalid' : '' }}" type="number" name="kuis_2" id="kuis_2" value="{{ old('kuis_2', $dataPreparation->kuis_2) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tugas_1') ? 'is-invalid' : '' }}" type="number" name="tugas_1" id="tugas_1" value="{{ old('tugas_1', $dataPreparation->tugas_1) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tugas_2') ? 'is-invalid' : '' }}" type="text" name="tugas_2" id="tugas_2" value="{{ old('tugas_2', $dataPreparation->tugas_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nilai_akhir') ? 'is-invalid' : '' }}" type="number" name="nilai_akhir" id="nilai_akhir" value="{{ old('nilai_akhir', $dataPreparation->nilai_akhir) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status_1') ? 'is-invalid' : '' }}" name="status_1" id="status_1">
                    ...
                    @foreach(App\Models\DataPreparation::STATUS_1_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status_1', $dataPreparation->status_1) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status_2') ? 'is-invalid' : '' }}" name="status_2" id="status_2">
                    ...
                    @foreach(App\Models\DataPreparation::STATUS_2_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status_2', $dataPreparation->status_2) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status_3') ? 'is-invalid' : '' }}" name="status_3" id="status_3">
                    ...
                    @foreach(App\Models\DataPreparation::STATUS_3_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status_3', $dataPreparation->status_3) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
